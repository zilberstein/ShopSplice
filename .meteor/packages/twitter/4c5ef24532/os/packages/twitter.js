...
Oauth.registerService('twitter', 1, urls, function(oauthBinding) {                                     // 14
  ...
  var serviceData = {                                                                                  // 17
    ...
    accessToken: oauthBinding.accessToken,                                                             // 20
    accessTokenSecret: oauthBinding.accessTokenSecret                                                  // 21
  };                                                                                                   // 22
                                                                                                       // 23
    ...
    options: {                                                                                         // 30
      profile: {                                                                                       // 31
        name: identity.name                                                                            // 32
                                                                                                       ...
                                                                                                       // 37
                                                                                                       // 38
Twitter.retrieveCredential = function(credentialToken) {                                               // 39
  return Oauth.retrieveCredential(credentialToken);                                                    // 40
};                                                                                                     // 41
                                                                                                       // 42
/////////////////////////////////////////////////////////////////////////////////////////////////////////
