...
var Fiber = Npm.require('fibers');                                                                                   // 1
                                                                                                                     ...
                                                                                                                     // 3
Tinytest.addAsync(                                                                                                   // 4
  "livedata server - connectionHandle.onClose()",                                                                    // 5
  function (test, onComplete) {                                                                                      // 6
    makeTestConnection(                                                                                              // 7
      test,                                                                                                          // 8
      function (clientConn, serverConn) {                                                                            // 9
        // On the server side, wait for the connection to be closed.                                                 // 10
        serverConn.onClose(function () {                                                                             // 11
          test.isTrue(true);                                                                                         // 12
          // Add a new onClose after the connection is already                                                       // 13
          // closed. See that it fires.                                                                              // 14
          serverConn.onClose(function () {                                                                           // 15
            onComplete();                                                                                            // 16
          });                                                                                                        // 17
        });                                                                                                          // 18
        // Close the connection from the client.                                                                     // 19
        clientConn.disconnect();                                                                                     // 20
      },                                                                                                             // 21
      onComplete                                                                                                     // 22
    );                                                                                                               // 23
  }                                                                                                                  // 24
                                                                                                                     ...
                                                                                                                     // 26
                                                                                                                     // 27
Tinytest.addAsync(                                                                                                   // 28
  "livedata server - connectionHandle.close()",                                                                      // 29
  function (test, onComplete) {                                                                                      // 30
    makeTestConnection(                                                                                              // 31
      test,                                                                                                          // 32
      function (clientConn, serverConn) {                                                                            // 33
        // Wait for the connection to be closed from the server side.                                                // 34
        simplePoll(                                                                                                  // 35
          function () {                                                                                              // 36
            return ! clientConn.status().connected;                                                                  // 37
          },                                                                                                         // 38
          onComplete,                                                                                                // 39
          function () {                                                                                              // 40
            test.fail("timeout waiting for the connection to be closed on the server side");                         // 41
            onComplete();                                                                                            // 42
          }                                                                                                          // 43
        );                                                                                                           // 44
                                                                                                                     // 45
        // Close the connection from the server.                                                                     // 46
        serverConn.close();                                                                                          // 47
      },                                                                                                             // 48
      onComplete                                                                                                     // 49
    );                                                                                                               // 50
                                                                                                                     ...
                                                                                                                     // 54
testAsyncMulti(                                                                                                      // 55
  "livedata server - onConnection doesn't get callback after stop.",                                                 // 56
  [function (test, expect) {                                                                                         // 57
    var afterStop = false;                                                                                           // 58
    var expectStop1 = expect();                                                                                      // 59
    var stopHandle1 = Meteor.onConnection(function (conn) {                                                          // 60
      stopHandle2.stop();                                                                                            // 61
      stopHandle1.stop();                                                                                            // 62
      afterStop = true;                                                                                              // 63
      // yield to the event loop for a moment to see that no other calls                                             // 64
      // to listener2 are called.                                                                                    // 65
      Meteor.setTimeout(expectStop1, 10);                                                                            // 66
    });                                                                                                              // 67
    var stopHandle2 = Meteor.onConnection(function (conn) {                                                          // 68
      test.isFalse(afterStop);                                                                                       // 69
    });                                                                                                              // 70
                                                                                                                     // 71
    // trigger a connection                                                                                          // 72
    var expectConnection = expect();                                                                                 // 73
    makeTestConnection(                                                                                              // 74
      test,                                                                                                          // 75
      function (clientConn, serverConn) {                                                                            // 76
        // Close the connection from the client.                                                                     // 77
        clientConn.disconnect();                                                                                     // 78
        expectConnection();                                                                                          // 79
      },                                                                                                             // 80
      expectConnection                                                                                               // 81
    );                                                                                                               // 82
                                                                                                                     ...
                                                                                                                     // 86
Meteor.methods({                                                                                                     // 87
  livedata_server_test_inner: function () {                                                                          // 88
    return this.connection.id;                                                                                       // 89
  },                                                                                                                 // 90
                                                                                                                     // 91
  livedata_server_test_outer: function () {                                                                          // 92
    return Meteor.call('livedata_server_test_inner');                                                                // 93
  }                                                                                                                  // 94
});                                                                                                                  // 95
                                                                                                                     // 96
                                                                                                                     // 97
Tinytest.addAsync(                                                                                                   // 98
  "livedata server - connection in method invocation",                                                               // 99
  function (test, onComplete) {                                                                                      // 100
    makeTestConnection(                                                                                              // 101
      test,                                                                                                          // 102
      function (clientConn, serverConn) {                                                                            // 103
        var res = clientConn.call('livedata_server_test_inner');                                                     // 104
        test.equal(res, serverConn.id);                                                                              // 105
        clientConn.disconnect();                                                                                     // 106
        onComplete();                                                                                                // 107
      },                                                                                                             // 108
      onComplete                                                                                                     // 109
    );                                                                                                               // 110
                                                                                                                     ...
                                                                                                                     // 113
                                                                                                                     // 114
Tinytest.addAsync(                                                                                                   // 115
  "livedata server - connection in nested method invocation",                                                        // 116
  function (test, onComplete) {                                                                                      // 117
    makeTestConnection(                                                                                              // 118
      test,                                                                                                          // 119
      function (clientConn, serverConn) {                                                                            // 120
        var res = clientConn.call('livedata_server_test_outer');                                                     // 121
        test.equal(res, serverConn.id);                                                                              // 122
        clientConn.disconnect();                                                                                     // 123
        onComplete();                                                                                                // 124
      },                                                                                                             // 125
      onComplete                                                                                                     // 126
    );                                                                                                               // 127
                                                                                                                     ...
                                                                                                                     // 130
                                                                                                                     // 131
// connectionId -> callback                                                                                          // 132
var onSubscription = {};                                                                                             // 133
                                                                                                                     // 134
Meteor.publish("livedata_server_test_sub", function (connectionId) {                                                 // 135
  var callback = onSubscription[connectionId];                                                                       // 136
  if (callback)                                                                                                      // 137
    callback(this);                                                                                                  // 138
  this.stop();                                                                                                       // 139
});                                                                                                                  // 140
                                                                                                                     // 141
                                                                                                                     // 142
Tinytest.addAsync(                                                                                                   // 143
  "livedata server - connection in publish function",                                                                // 144
  function (test, onComplete) {                                                                                      // 145
    makeTestConnection(                                                                                              // 146
      test,                                                                                                          // 147
      function (clientConn, serverConn) {                                                                            // 148
        onSubscription[serverConn.id] = function (subscription) {                                                    // 149
          delete onSubscription[serverConn.id];                                                                      // 150
          test.equal(subscription.connection.id, serverConn.id);                                                     // 151
          clientConn.disconnect();                                                                                   // 152
          onComplete();                                                                                              // 153
        };                                                                                                           // 154
        clientConn.subscribe("livedata_server_test_sub", serverConn.id);                                             // 155
      }                                                                                                              // 156
    );                                                                                                               // 157
  }                                                                                                                  // 158
);                                                                                                                   // 159
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                     //
var newView = function(test) {                                                                                       // 1
  var results = [];                                                                                                  // 2
  var view = new LivedataTest.SessionCollectionView('test', {                                                        // 3
    added: function (collection, id, fields) {                                                                       // 4
      results.push({fun: 'added', id: id, fields: fields});                                                          // 5
    },                                                                                                               // 6
    changed: function (collection, id, changed) {                                                                    // 7
      if (_.isEmpty(changed))                                                                                        // 8
        return;                                                                                                      // 9
      results.push({fun: 'changed', id: id, changed: changed});                                                      // 10
    },                                                                                                               // 11
    removed: function (collection, id) {                                                                             // 12
      results.push({fun: 'removed', id: id});                                                                        // 13
    }                                                                                                                // 14
  });                                                                                                                // 15
  var v = {                                                                                                          // 16
    view: view,                                                                                                      // 17
  ...
  _.each(["added", "changed", "removed"], function (it) {                                                            // 20
    v[it] = _.bind(view[it], view);                                                                                  // 21
  });                                                                                                                // 22
  v.expectResult = function (result) {                                                                               // 23
    test.equal(results.shift(), result);                                                                             // 24
  };                                                                                                                 // 25
  v.expectNoResult = function () {                                                                                   // 26
    test.equal(results, []);                                                                                         // 27
  };                                                                                                                 // 28
  v.drain = function() {                                                                                             // 29
    var ret = results;                                                                                               // 30
    results = [];                                                                                                    // 31
  ...
  return v;                                                                                                          // 34
                                                                                                                     ...
                                                                                                                     // 36
Tinytest.add('livedata - sessionview - exists reveal', function (test) {                                             // 37
  var v = newView(test);                                                                                             // 38
                                                                                                                     // 39
  v.added("A", "A1", {});                                                                                            // 40
  v.expectResult({fun: 'added', id: "A1", fields: {}});                                                              // 41
  v.expectNoResult();                                                                                                // 42
                                                                                                                     // 43
  v.added("B", "A1", {});                                                                                            // 44
  v.expectNoResult();                                                                                                // 45
  ...
  v.expectNoResult();                                                                                                // 48
                                                                                                                     // 49
  v.removed("B", "A1");                                                                                              // 50
  v.expectResult({fun: 'removed', id: "A1"});                                                                        // 51
  v.expectNoResult();                                                                                                // 52
});                                                                                                                  // 53
                                                                                                                     // 54
Tinytest.add('livedata - sessionview - added a second field in another sub', function (test) {                       // 55
  var v = newView(test);                                                                                             // 56
                                                                                                                     // 57
  v.added("A", "A1", {a: "foo"});                                                                                    // 58
  v.expectResult({fun: 'added', id: "A1", fields: {a: "foo"}});                                                      // 59
  v.expectNoResult();                                                                                                // 60
                                                                                                                     // 61
  v.added("B", "A1", {a: "foo", b: "bar"});                                                                          // 62
  v.expectResult({fun: 'changed', 'id': "A1", changed: {b: "bar"}});                                                 // 63
                                                                                                                     // 64
  v.removed("A", "A1");                                                                                              // 65
  v.expectNoResult();                                                                                                // 66
                                                                                                                     // 67
  v.removed("B", "A1");                                                                                              // 68
  v.expectResult({fun: 'removed', id: "A1"});                                                                        // 69
  v.expectNoResult();                                                                                                // 70
});                                                                                                                  // 71
                                                                                                                     // 72
                                                                                                                     // 73
Tinytest.add('livedata - sessionview - field reveal', function (test) {                                              // 74
  var v = newView(test);                                                                                             // 75
                                                                                                                     // 76
  v.added("A",  "A1", {foo: "bar"});                                                                                 // 77
  v.expectResult({fun: 'added', id: "A1", fields: {foo: "bar"}});                                                    // 78
  v.expectNoResult();                                                                                                // 79
                                                                                                                     // 80
  v.added("B",  "A1", {foo: "baz"});                                                                                 // 81
  v.removed("A", "A1");                                                                                              // 82
  v.expectResult({fun: 'changed', id: "A1", changed: {foo: "baz"}});                                                 // 83
  v.expectNoResult();                                                                                                // 84
  // Somewhere in here we must have changed foo to baz. Legal either on the                                          // 85
  // added or on the removed, but only once.                                                                         // 86
                                                                                                                     // 87
  v.removed("B", "A1");                                                                                              // 88
  v.expectResult({fun: 'removed', id: "A1"});                                                                        // 89
  v.expectNoResult();                                                                                                // 90
});                                                                                                                  // 91
                                                                                                                     // 92
Tinytest.add('livedata - sessionview - field change', function (test) {                                              // 93
  var v = newView(test);                                                                                             // 94
                                                                                                                     // 95
  v.added("A",  "A1", {foo: "bar"});                                                                                 // 96
  v.expectResult({fun: 'added', id: "A1", fields: {foo: "bar"}});                                                    // 97
  v.expectNoResult();                                                                                                // 98
                                                                                                                     // 99
  v.changed("A", "A1", {foo: "baz"}, []);                                                                            // 100
  v.expectResult({fun: 'changed', id: "A1", changed: {foo: "baz"}});                                                 // 101
  v.expectNoResult();                                                                                                // 102
                                                                                                                     // 103
  v.removed("A", "A1");                                                                                              // 104
  v.expectResult({fun: 'removed', id: "A1"});                                                                        // 105
  v.expectNoResult();                                                                                                // 106
});                                                                                                                  // 107
                                                                                                                     // 108
Tinytest.add('livedata - sessionview - field clear', function (test) {                                               // 109
  var v = newView(test);                                                                                             // 110
                                                                                                                     // 111
  v.added("A",  "A1", {foo: "bar"});                                                                                 // 112
  v.expectResult({fun: 'added', id: "A1", fields: {foo: "bar"}});                                                    // 113
  v.expectNoResult();                                                                                                // 114
                                                                                                                     // 115
  v.changed("A", "A1", {foo: undefined});                                                                            // 116
  v.expectResult({fun: 'changed', id: "A1", changed: {foo: undefined}});                                             // 117
  v.expectNoResult();                                                                                                // 118
                                                                                                                     // 119
  v.removed("A", "A1");                                                                                              // 120
  v.expectResult({fun: 'removed', id: "A1"});                                                                        // 121
  v.expectNoResult();                                                                                                // 122
});                                                                                                                  // 123
                                                                                                                     // 124
Tinytest.add('livedata - sessionview - change makes a new field', function (test) {                                  // 125
  var v = newView(test);                                                                                             // 126
                                                                                                                     // 127
  v.added("A",  "A1", {foo: "bar"});                                                                                 // 128
  v.expectResult({fun: 'added', id: "A1", fields: {foo: "bar"}});                                                    // 129
  v.expectNoResult();                                                                                                // 130
                                                                                                                     // 131
  v.changed("A", "A1", {baz:"quux"});                                                                                // 132
  v.expectResult({fun: 'changed', id: "A1", changed: {baz: "quux"}});                                                // 133
  v.expectNoResult();                                                                                                // 134
});                                                                                                                  // 135
                                                                                                                     // 136
Tinytest.add('livedata - sessionview - add, remove, add', function (test) {                                          // 137
  var v = newView(test);                                                                                             // 138
                                                                                                                     // 139
  v.added("A",  "A1", {foo: "bar"});                                                                                 // 140
  v.expectResult({fun: 'added', id: "A1", fields: {foo: "bar"}});                                                    // 141
  v.expectNoResult();                                                                                                // 142
                                                                                                                     // 143
  v.removed("A", "A1");                                                                                              // 144
  v.expectResult({fun: 'removed', id: "A1"});                                                                        // 145
  v.expectNoResult();                                                                                                // 146
                                                                                                                     // 147
  v.added("A",  "A1", {foo: "bar"});                                                                                 // 148
  v.expectResult({fun: 'added', id: "A1", fields: {foo: "bar"}});                                                    // 149
  v.expectNoResult();                                                                                                // 150
                                                                                                                     // 151
});                                                                                                                  // 152
                                                                                                                     // 153
Tinytest.add('livedata - sessionview - field clear reveal', function (test) {                                        // 154
  var v = newView(test);                                                                                             // 155
                                                                                                                     // 156
  v.added("A",  "A1", {foo: "bar"});                                                                                 // 157
  v.expectResult({fun: 'added', id: "A1", fields: {foo: "bar"}});                                                    // 158
  v.expectNoResult();                                                                                                // 159
                                                                                                                     // 160
                                                                                                                     // 161
  v.added("B",  "A1", {foo: "baz"});                                                                                 // 162
  v.changed("A", "A1", {foo: undefined});                                                                            // 163
  v.expectResult({fun: 'changed', id: "A1", changed: {foo: "baz"}});                                                 // 164
  v.expectNoResult();                                                                                                // 165
                                                                                                                     // 166
  v.removed("A", "A1");                                                                                              // 167
  v.expectNoResult();                                                                                                // 168
  v.removed("B", "A1");                                                                                              // 169
  v.expectResult({fun: 'removed', id: "A1"});                                                                        // 170
  v.expectNoResult();                                                                                                // 171
});                                                                                                                  // 172
                                                                                                                     // 173
Tinytest.add('livedata - sessionview - change to canonical value produces no change', function (test) {              // 174
  var v = newView(test);                                                                                             // 175
                                                                                                                     // 176
  v.added("A",  "A1", {foo: "bar"});                                                                                 // 177
  v.expectResult({fun: 'added', id: "A1", fields: {foo: "bar"}});                                                    // 178
  v.expectNoResult();                                                                                                // 179
                                                                                                                     // 180
                                                                                                                     // 181
  v.added("B",  "A1", {foo: "baz"});                                                                                 // 182
  var canon = "bar";                                                                                                 // 183
  var maybeResults = v.drain();                                                                                      // 184
  if (!_.isEmpty(maybeResults)) {                                                                                    // 185
    // if something happened, it was a change message to baz.                                                        // 186
    // if nothing did, canon is still bar.                                                                           // 187
    test.length(maybeResults, 1);                                                                                    // 188
    test.equal(maybeResults[0], {fun: 'changed', id: "A1", changed: {foo: "baz"}});                                  // 189
    canon = "baz";                                                                                                   // 190
  }                                                                                                                  // 191
  v.changed("B", "A1", {foo: canon});                                                                                // 192
  v.expectNoResult();                                                                                                // 193
                                                                                                                     // 194
  v.removed("A", "A1");                                                                                              // 195
  v.expectNoResult();                                                                                                // 196
  v.removed("B", "A1");                                                                                              // 197
  v.expectResult({fun: 'removed', id: "A1"});                                                                        // 198
  v.expectNoResult();                                                                                                // 199
});                                                                                                                  // 200
                                                                                                                     // 201
Tinytest.add('livedata - sessionview - new field of canonical value produces no change', function (test) {           // 202
  var v = newView(test);                                                                                             // 203
                                                                                                                     // 204
  v.added("A",  "A1", {foo: "bar"});                                                                                 // 205
  v.expectResult({fun: 'added', id: "A1", fields: {foo: "bar"}});                                                    // 206
  v.expectNoResult();                                                                                                // 207
                                                                                                                     // 208
                                                                                                                     // 209
  v.added("B",  "A1", {});                                                                                           // 210
                                                                                                                     // 211
  v.changed("B", "A1", {foo: "bar"});                                                                                // 212
  v.expectNoResult();                                                                                                // 213
                                                                                                                     // 214
  v.removed("A", "A1");                                                                                              // 215
  v.expectNoResult();                                                                                                // 216
  v.removed("B", "A1");                                                                                              // 217
  v.expectResult({fun: 'removed', id: "A1"});                                                                        // 218
  v.expectNoResult();                                                                                                // 219
});                                                                                                                  // 220
                                                                                                                     // 221
Tinytest.add('livedata - sessionview - clear all clears only once', function (test) {                                // 222
  var v = newView(test);                                                                                             // 223
                                                                                                                     // 224
  v.added("A",  "A1", {foo: "bar"});                                                                                 // 225
  v.expectResult({fun: 'added', id: "A1", fields: {foo: "bar"}});                                                    // 226
  v.expectNoResult();                                                                                                // 227
                                                                                                                     // 228
  v.added("B",  "A1", {foo: "bar"});                                                                                 // 229
  v.added("C",  "A1", {foo: "bar"});                                                                                 // 230
  v.changed("A", "A1", {foo: undefined});                                                                            // 231
  v.changed("B", "A1", {foo: undefined});                                                                            // 232
  v.changed("C", "A1", {foo: undefined});                                                                            // 233
  v.expectResult({fun: 'changed', id: "A1", changed: {foo: undefined}});                                             // 234
  v.expectNoResult();                                                                                                // 235
                                                                                                                     // 236
  v.removed("A", "A1");                                                                                              // 237
  v.expectNoResult();                                                                                                // 238
  v.removed("B", "A1");                                                                                              // 239
  v.expectNoResult();                                                                                                // 240
});                                                                                                                  // 241
                                                                                                                     // 242
Tinytest.add('livedata - sessionview - change all changes only once', function (test) {                              // 243
  var v = newView(test);                                                                                             // 244
                                                                                                                     // 245
  v.added("A",  "A1", {foo: "bar"});                                                                                 // 246
  v.expectResult({fun: 'added', id: "A1", fields: {foo: "bar"}});                                                    // 247
  v.expectNoResult();                                                                                                // 248
                                                                                                                     // 249
  v.added("B",  "A1", {foo: "bar"});                                                                                 // 250
  v.added("C",  "A1", {foo: "bar"});                                                                                 // 251
  v.changed("B", "A1", {foo: "baz"});                                                                                // 252
  v.changed("A", "A1", {foo: "baz"});                                                                                // 253
  v.changed("C", "A1", {foo: "baz"});                                                                                // 254
  v.expectResult({fun: 'changed', id: "A1", changed: {foo: "baz"}});                                                 // 255
  v.expectNoResult();                                                                                                // 256
                                                                                                                     // 257
  v.removed("A", "A1");                                                                                              // 258
  v.expectNoResult();                                                                                                // 259
  v.removed("B", "A1");                                                                                              // 260
  v.expectNoResult();                                                                                                // 261
});                                                                                                                  // 262
                                                                                                                     // 263
Tinytest.add('livedata - sessionview - multiple operations at once in a change', function (test) {                   // 264
  var v = newView(test);                                                                                             // 265
                                                                                                                     // 266
  v.added("A",  "A1", {foo: "bar", baz: "quux"});                                                                    // 267
  v.expectResult({fun: 'added', id: "A1", fields: {foo: "bar", baz: "quux"}});                                       // 268
  v.expectNoResult();                                                                                                // 269
                                                                                                                     // 270
                                                                                                                     // 271
  v.added("B",  "A1", {foo: "baz"});                                                                                 // 272
  v.changed("A", "A1", {thing: "stuff", foo: undefined, baz: undefined});                                            // 273
  v.expectResult({fun: 'changed', id: "A1", changed: {foo: "baz", thing: "stuff", baz: undefined}});                 // 274
  v.expectNoResult();                                                                                                // 275
                                                                                                                     // 276
  v.removed("A", "A1");                                                                                              // 277
  v.expectResult({fun: 'changed', id: "A1", changed: {thing: undefined}});                                           // 278
  v.expectNoResult();                                                                                                // 279
  v.removed("B", "A1");                                                                                              // 280
  v.expectResult({fun: 'removed', id: "A1"});                                                                        // 281
  v.expectNoResult();                                                                                                // 282
});                                                                                                                  // 283
                                                                                                                     // 284
Tinytest.add('livedata - sessionview - more than one document', function (test) {                                    // 285
  var v = newView(test);                                                                                             // 286
                                                                                                                     // 287
  v.added("A",  "A1", {foo: "bar", baz: "quux"});                                                                    // 288
  v.expectResult({fun: 'added', id: "A1", fields: {foo: "bar", baz: "quux"}});                                       // 289
  v.expectNoResult();                                                                                                // 290
                                                                                                                     // 291
                                                                                                                     // 292
  v.added("A", "A2", {foo: "baz"});                                                                                  // 293
  v.expectResult({fun: 'added', id: "A2", fields: {foo: "baz"}});                                                    // 294
  v.changed("A", "A1", {thing: "stuff", foo: undefined, baz: undefined});                                            // 295
  v.expectResult({fun: 'changed', id: "A1", changed: {thing: "stuff", foo: undefined, baz: undefined}});             // 296
  v.expectNoResult();                                                                                                // 297
                                                                                                                     // 298
  v.removed("A", "A1");                                                                                              // 299
  v.expectResult({fun: 'removed', id: "A1"});                                                                        // 300
  v.expectNoResult();                                                                                                // 301
  v.removed("A", "A2");                                                                                              // 302
  v.expectResult({fun: 'removed', id: "A2"});                                                                        // 303
  v.expectNoResult();                                                                                                // 304
                                                                                                                     // 305
});                                                                                                                  // 306
                                                                                                                     // 307
Tinytest.add('livedata - sessionview - multiple docs removed', function (test) {                                     // 308
  var v = newView(test);                                                                                             // 309
                                                                                                                     // 310
  v.added("A",  "A1", {foo: "bar", baz: "quux"});                                                                    // 311
  v.expectResult({fun: 'added', id: "A1", fields: {foo: "bar", baz: "quux"}});                                       // 312
  v.expectNoResult();                                                                                                // 313
                                                                                                                     // 314
                                                                                                                     // 315
  v.added("A", "A2", {foo: "baz"});                                                                                  // 316
  v.expectResult({fun: 'added', id: "A2", fields: {foo: "baz"}});                                                    // 317
  v.expectNoResult();                                                                                                // 318
                                                                                                                     // 319
  v.removed("A", "A1");                                                                                              // 320
  v.expectResult({fun: 'removed', id: "A1"});                                                                        // 321
  v.removed("A", "A2");                                                                                              // 322
  v.expectResult({fun: 'removed', id: "A2"});                                                                        // 323
  v.expectNoResult();                                                                                                // 324
});                                                                                                                  // 325
                                                                                                                     // 326
                                                                                                                     // 327
Tinytest.add('livedata - sessionview - complicated sequence', function (test) {                                      // 328
  var v = newView(test);                                                                                             // 329
                                                                                                                     // 330
  v.added("A",  "A1", {foo: "bar", baz: "quux"});                                                                    // 331
  v.expectResult({fun: 'added', id: "A1", fields: {foo: "bar", baz: "quux"}});                                       // 332
  v.expectNoResult();                                                                                                // 333
                                                                                                                     // 334
  v.added("A", "A2", {foo: "eats"});                                                                                 // 335
  v.expectResult({fun: 'added', id: "A2", fields: {foo: "eats"}});                                                   // 336
                                                                                                                     // 337
  v.added("B",  "A1", {foo: "baz"});                                                                                 // 338
  v.changed("A", "A1", {thing: "stuff", foo: undefined, baz: undefined});                                            // 339
  v.expectResult({fun: 'changed', id: "A1", changed: {foo: "baz", thing: "stuff", baz: undefined}});                 // 340
  v.expectNoResult();                                                                                                // 341
                                                                                                                     // 342
  v.removed("A", "A1");                                                                                              // 343
  v.removed("A", "A2");                                                                                              // 344
  v.expectResult({fun: 'changed', id: "A1", changed: {thing: undefined}});                                           // 345
  v.expectResult({fun: 'removed', id: "A2"});                                                                        // 346
  v.expectNoResult();                                                                                                // 347
  v.removed("B", "A1");                                                                                              // 348
  v.expectResult({fun: 'removed', id: "A1"});                                                                        // 349
  v.expectNoResult();                                                                                                // 350
});                                                                                                                  // 351
                                                                                                                     // 352
Tinytest.add('livedata - sessionview - added becomes changed', function (test) {                                     // 353
  var v = newView(test);                                                                                             // 354
                                                                                                                     // 355
  v.added('A',  "A1", {foo: 'bar'});                                                                                 // 356
  v.expectResult({fun: 'added', id: "A1", fields: {foo: 'bar'}});                                                    // 357
                                                                                                                     // 358
  v.added('B',  "A1", {hi: 'there'});                                                                                // 359
  v.expectResult({fun: 'changed', id: 'A1', changed: {hi: 'there'}});                                                // 360
                                                                                                                     // 361
  v.removed('A', 'A1');                                                                                              // 362
  v.expectResult({fun: 'changed', id: 'A1', changed: {foo: undefined}});                                             // 363
                                                                                                                     // 364
  v.removed('B', 'A1');                                                                                              // 365
  v.expectResult({fun: 'removed', id: 'A1'});                                                                        // 366
});                                                                                                                  // 367
                                                                                                                     // 368
Tinytest.add('livedata - sessionview - weird key names', function (test) {                                           // 369
  var v = newView(test);                                                                                             // 370
                                                                                                                     // 371
  v.added('A',  "A1", {});                                                                                           // 372
  v.expectResult({fun: 'added', id: "A1", fields: {}});                                                              // 373
                                                                                                                     // 374
  v.changed('A',  "A1", {constructor: 'bla'});                                                                       // 375
  v.expectResult({fun: 'changed', id: 'A1', changed: {constructor: 'bla'}});                                         // 376
});                                                                                                                  // 377
                                                                                                                     // 378
Tinytest.add('livedata - sessionview - clear undefined value', function (test) {                                     // 379
  var v = newView(test);                                                                                             // 380
                                                                                                                     // 381
  v.added("A", "A1", {field: "value"});                                                                              // 382
  v.expectResult({fun: 'added', id: "A1", fields: {field: "value"}});                                                // 383
  v.expectNoResult();                                                                                                // 384
                                                                                                                     // 385
  v.changed("A", "A1", {field: undefined});                                                                          // 386
  v.expectResult({fun: 'changed', id: 'A1', changed: {field: undefined}});                                           // 387
  v.expectNoResult();                                                                                                // 388
                                                                                                                     // 389
  v.changed("A", "A1", {field: undefined});                                                                          // 390
  v.expectNoResult();                                                                                                // 391
                                                                                                                     // 392
});                                                                                                                  // 393
                                                                                                                     // 394
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                   //
// packages/livedata/crossbar_tests.js                                                                               //
//                                                                                                                   //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                     //
// White box tests of invalidation crossbar matching function.                                                       // 1
// Note: the current crossbar match function is designed specifically                                                // 2
// to ensure that a modification that targets a specific ID does not                                                 // 3
// notify a query that is watching a different specific ID. (And to                                                  // 4
// keep separate collections separate.) Other than that, there's no                                                  // 5
// deep meaning to the matching function, and it could be changed later                                              // 6
// as long as it preserves that property.                                                                            // 7
Tinytest.add('livedata - crossbar', function (test) {                                                                // 8
  var crossbar = new DDPServer._Crossbar;                                                                            // 9
  test.isTrue(crossbar._matches({collection: "C"},                                                                   // 10
                                {collection: "C"}));                                                                 // 11
  test.isTrue(crossbar._matches({collection: "C", id: "X"},                                                          // 12
                                {collection: "C"}));                                                                 // 13
  test.isTrue(crossbar._matches({collection: "C"},                                                                   // 14
                                {collection: "C", id: "X"}));                                                        // 15
  test.isTrue(crossbar._matches({collection: "C", id: "X"},                                                          // 16
                                {collection: "C"}));                                                                 // 17
                                                                                                                     // 18
  test.isFalse(crossbar._matches({collection: "C", id: "X"},                                                         // 19
                                 {collection: "C", id: "Y"}));                                                       // 20
});                                                                                                                  // 21
                                                                                                                     // 22
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                   //
// packages/livedata/stream_client_tests.js                                                                          //
//                                                                                                                   //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                     //
var Fiber = Npm.require('fibers');                                                                                   // 1
                                                                                                                     // 2
Tinytest.addAsync("stream client - callbacks run in a fiber", function (test, onComplete) {                          // 3
  stream = new LivedataTest.ClientStream(                                                                            // 4
    Meteor.absoluteUrl(),                                                                                            // 5
    {                                                                                                                // 6
      _testOnClose: function () {                                                                                    // 7
        test.isTrue(Fiber.current);                                                                                  // 8
        onComplete();                                                                                                // 9
      }                                                                                                              // 10
    }                                                                                                                // 11
  );                                                                                                                 // 12
  stream.on('reset', function () {                                                                                   // 13
    test.isTrue(Fiber.current);                                                                                      // 14
    stream.disconnect();                                                                                             // 15
  });                                                                                                                // 16
});                                                                                                                  // 17
                                                                                                                     // 18
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
